...
module.exports = {
  ...
  client: env.CLIENT_CONF ? env.CLIENT_CONF.split(',') : [ "protocol", "host", "publicPort", "env", "logo", "favicon", "organization name", "organization url", "google analytics tracking id", "recaptchaPublicKey" ],
  auth: {
    basic: {
